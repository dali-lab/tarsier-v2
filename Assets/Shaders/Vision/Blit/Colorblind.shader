Shader "Anivision/Colorblind"
{
	Properties
	{
		...
		[KeywordEnum(Protanopia, Protanomaly, Deuteranopia, Deuteranomaly, Tritanopia, Tritanomaly, Achromatopsia, Achromatomaly, Custom)] _Type("Colorblindness Type", Float) = 0
	}
	SubShader
	{
		// No culling or depth
		...
		Pass
		{
			...
			#pragma multi_compile _TYPE_PROTANOPIA _TYPE_PROTANOMALY _TYPE_DEUTERANOPIA _TYPE_DEUTERANOMALY _TYPE_TRITANOPIA _TYPE_TRITANOMALY _TYPE_ACHROMATOPSIA _TYPE_ACHROMATOMALY _TYPE_CUSTOM
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				#elif _TYPE_CUSTOM
				const float4x4 m = _CustomMatrix;
				#endif
